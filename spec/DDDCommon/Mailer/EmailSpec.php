...
namespace spec\DDDCommon\Mailer;

use DDDCommon\Mailer\AttachmentInterface;
use DDDCommon\Mailer\Email;
use DDDCommon\Mailer\EmailAddressInterface;
use DDDCommon\Mailer\EmailBodyInterface;
use Faker\Factory;
